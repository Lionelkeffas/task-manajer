 ...
 completed: { backgroundColor: '#F1F5F9', opacity: 0.8 },
 priorityIndicator: { width: 4, height: '100%', borderRadius: 2, marginRight: 12 },
 checkbox: { width: 24, height: 24, borderRadius: 6, borderWidth: 2,
 borderColor: '#DBEAFE', alignItems: 'center', justifyContent: 'center',
 marginRight: 12, backgroundColor: '#F8FAFC' },
 checkboxDone: { backgroundColor: '#1A56DB', borderColor: '#1A56DB' },
 checkmark: { color: 'FFFFFF', fontSize: 14, fontWeight: 'bold' },
 content: { flex: 1 },
 title: { fontSize: 16, fontWeight: '500', color: '#1E293B', marginBottom: 4 },
