 ...
 <TouchableOpacity
 key={key}
 style={[styles.tab, currentFilter === key && styles.activeTab]}
 onPress={() => onFilterChange(key)}
 >
 <Text style={[styles.label, currentFilter === key && styles.activeLabel]}>
 {label}
 </Text>
 </TouchableOpacity>
 ))}
 ...
 container: { flexDirection: 'row', backgroundColor: '#E2E8F0',
