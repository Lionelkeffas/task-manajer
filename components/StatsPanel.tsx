// components/StatsPanel.tsx
 ...
 interface StatsPanelProps { tasks: Task[]; }
 ...
 <View style={styles.statItem}>
 <Text style={[styles.value, { color: '#16A34A' }]}>{stats.completed}</Text>
 <Text style={styles.label}>Selesai</Text>
 </View>
 <View style={styles.statItem}>
 <Text style={[styles.value, { color: '#DC2626' }]}>{stats.high}</Text>
 <Text style={styles.label}>Prioritas Tinggi</Text>
 </View>
 <View style={styles.statItem}>
 <Text style={[styles.value, { color: '#1A56DB' }]}>{stats.progress}%</Text>
