import React, { useState } from 'react';
 ...
 import { TaskInputProps, Priority } from '../types/task';
 ...
 Alert.alert('Error', 'Nama task minimal 3 karakter!');
 return;
 }
 ...
 <Text style={styles.label}>Nama Task:</Text>
 <TextInput
 style={styles.input}
 value={title}
 ...
 input: { borderWidth: 1, borderColor: '#DBEAFE', borderRadius: 8,
 padding: 12, fontSize: 16, marginBottom: 12, backgroundColor: '#F8FAFC' },
